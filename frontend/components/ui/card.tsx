...
/* M3-style surface card. Rounded-2xl by default; interactive variants get a
...
const CardTitle = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div ref={ref} className={cn("text-xl font-semibold tracking-tight text-ink", className)} {...props} />
  ),
);
